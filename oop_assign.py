...
class Notepad:
    ...
    def read_notes(self):
        ...
        print(f"name".center(13), f"title".center(21), f"body".center(26), f"time".center(30), sep= " | ")
        print(f"-" * 100)
...
#         squared_variance = summation_x_xbar/self.count() - 1 # variance stops here
#         variance = squared_variance ** 0.5 # This is standard deviation
#         return variance
...
# analyzer = Data_Analyzer("Number.csv")
# print(analyzer.numbers)
# print(analyzer.count())
# print(analyzer.mean())
# print(analyzer.max())
# print(analyzer.min())
# print(analyzer.variance())
