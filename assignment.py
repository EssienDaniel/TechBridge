...
class Notepad:
    ...
    def read_notes(self):
        ...
        print(f"date".center(30), f"name".center(13),
            f"title".center(21), f"body".center(26), sep=" | ")
        print(f"-" * 100)
        ...
        for line in data.splitlines():
            ...
            print(f"{today}".center(30), f"{name}".center(13),
                f"{title}".center(21), f"{body}".center(26), sep=" | ")
    ...
    def read_personal_notes(self):
        ...
        for line in data.splitlines():
            ...
            # print(name.strip() == self.user.name.strip())

            if name.strip() == self.user.name.strip():
                today = datetime.datetime.now()
                print(f"{today}".center(15), f"{name}".center(13),
                    f"{title}".center(21), f"{body}".center(26), sep=" | ")
                # else:
                #     print("Not found")
